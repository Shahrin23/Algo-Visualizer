...
void GraphVisualizer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->enableGraphButtons(); break;
        case 2: _t->disableGraphButtons(); break;
        case 3: _t->setTimeElapsed((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 4: _t->processNextStep(); break;
        case 5: _t->updateTimeElapsed(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (GraphVisualizer::*)(const QPoint & , int )>(_a, &GraphVisualizer::requestEdgeValueInput, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (GraphVisualizer::*)()>(_a, &GraphVisualizer::enableGraphButtons, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (GraphVisualizer::*)()>(_a, &GraphVisualizer::disableGraphButtons, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (GraphVisualizer::*)(int )>(_a, &GraphVisualizer::setTimeElapsed, 3))
            return;
    }
}
