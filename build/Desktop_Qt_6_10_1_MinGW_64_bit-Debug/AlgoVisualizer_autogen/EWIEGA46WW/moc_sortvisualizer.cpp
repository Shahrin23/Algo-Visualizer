...
void SortVisualizer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->enableSortButtons(); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SortVisualizer::*)()>(_a, &SortVisualizer::enableSortButtons, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (SortVisualizer::*)()>(_a, &SortVisualizer::disableButtons, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (SortVisualizer::*)(int )>(_a, &SortVisualizer::setTimeElapsed, 2))
            return;
    }
}
...
// SIGNAL 0
void SortVisualizer::enableSortButtons()
{
