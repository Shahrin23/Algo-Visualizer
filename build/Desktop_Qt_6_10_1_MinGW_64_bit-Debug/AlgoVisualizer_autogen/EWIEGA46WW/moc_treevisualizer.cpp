...
template <> constexpr inline auto TreeVisualizer::qt_create_metaobjectdata<qt_meta_tag_ZN14TreeVisualizerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'enableTreeButtons'
        QtMocHelpers::SignalData<void()>(1, 2, QMC::AccessPublic, QMetaType::Void),
        // Signal 'disableTreeButtons'
...
void TreeVisualizer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->enableTreeButtons(); break;
        case 1: _t->disableTreeButtons(); break;
        case 2: _t->setTimeElapsed((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (TreeVisualizer::*)()>(_a, &TreeVisualizer::enableTreeButtons, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (TreeVisualizer::*)()>(_a, &TreeVisualizer::disableTreeButtons, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (TreeVisualizer::*)(int )>(_a, &TreeVisualizer::setTimeElapsed, 2))
            return;
    }
}
...
// SIGNAL 0
void TreeVisualizer::enableTreeButtons()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void TreeVisualizer::disableTreeButtons()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void TreeVisualizer::setTimeElapsed(int _t1)
{
